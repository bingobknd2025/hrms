    ...
    <script type="module" defer>
        $(document).ready(function() {
            ...
            Morris.Bar({
                ...
                data: [{
                        y: 'Jan',
                        a: "{{$budget_collection->get(0)->sum('total_revenue')}}",
                        b: "{{$budget_collection->get(0)->sum('total_expense')}}"
                    },
                    {
                        y: 'Feb',
                        a: "{{$budget_collection->get(1)->sum('total_revenue')}}",
                        b: "{{$budget_collection->get(1)->sum('total_expense')}}"
                    },
                    {
                        y: 'Mar',
                        a: "{{$budget_collection->get(2)->sum('total_revenue')}}",
                        b: "{{$budget_collection->get(2)->sum('total_expense')}}"
                    },
                    {
                        y: 'Apr',
                        a: "{{$budget_collection->get(3)->sum('total_revenue')}}",
                        b: "{{$budget_collection->get(3)->sum('total_expense')}}"
                    },
                    {
                        y: 'May',
                        a: "{{$budget_collection->get(4)->sum('total_revenue')}}",
                        b: "{{$budget_collection->get(4)->sum('total_expense')}}"
                    },
                    {
                        y: 'Jun',
                        a: "{{$budget_collection->get(5)->sum('total_revenue')}}",
                        b: "{{$budget_collection->get(5)->sum('total_expense')}}"
                    },
                    {
                        y: 'Jul',
                        a: "{{$budget_collection->get(6)->sum('total_revenue')}}",
                        b: "{{$budget_collection->get(6)->sum('total_expense')}}"
                    },
                    {
                        y: 'Aug',
                        a: "{{$budget_collection->get(7)->sum('total_revenue')}}",
                        b: "{{$budget_collection->get(7)->sum('total_expense')}}"
                    },
                    {
                        y: 'Sept',
                        a: "{{$budget_collection->get(8)->sum('total_revenue')}}",
                        b: "{{$budget_collection->get(8)->sum('total_expense')}}"
                    },
                    {
                        y: 'Oct',
                        a: "{{$budget_collection->get(9)->sum('total_revenue')}}",
                        b: "{{$budget_collection->get(9)->sum('total_expense')}}"
                    },
                    {
                        y: 'Nov',
                        a: "{{$budget_collection->get(10)->sum('total_revenue')}}",
                        b: "{{$budget_collection->get(10)->sum('total_expense')}}"
                    },
                    {
                        y: 'Dec',
                        a: "{{$budget_collection->get(11)->sum('total_revenue')}}",
                        b: "{{$budget_collection->get(11)->sum('total_expense')}}"
                    },
                ],
                xkey: 'y',
                ykeys: ['a', 'b'],
            ...
            Morris.Line({
                ...
                data: [{
                        y: 1,
                        a: "{{$invoice_collection->get(0)->sum('grand_total')}}",
                        b: "{{$estimates_collection->get(0)->sum('grand_total')}}"
                    },
                    {
                        y: 2,
                        a: "{{$invoice_collection->get(1)->sum('grand_total')}}",
                        b: "{{$estimates_collection->get(1)->sum('grand_total')}}"
                    },
                    {
                        y: 3,
                        a: "{{$invoice_collection->get(2)->sum('grand_total')}}",
                        b: "{{$estimates_collection->get(2)->sum('grand_total')}}"
                    },
                    {
                        y: 4,
                        a: "{{$invoice_collection->get(3)->sum('grand_total')}}",
                        b: "{{$estimates_collection->get(3)->sum('grand_total')}}"
                    },
                    {
                        y: 5,
                        a: "{{$invoice_collection->get(4)->sum('grand_total')}}",
                        b: "{{$estimates_collection->get(4)->sum('grand_total')}}"
                    },
                    {
                        y: 6,
                        a: "{{$invoice_collection->get(5)->sum('grand_total')}}",
                        b: "{{$estimates_collection->get(5)->sum('grand_total')}}"
                    },
                    {
                        y: 7,
                        a: "{{$invoice_collection->get(6)->sum('grand_total')}}",
                        b: "{{$estimates_collection->get(6)->sum('grand_total')}}"
                    },
                    {
                        y: 8,
                        a: "{{$invoice_collection->get(7)->sum('grand_total')}}",
                        b: "{{$estimates_collection->get(7)->sum('grand_total')}}"
                    },
                    {
                        y: 9,
                        a: "{{$invoice_collection->get(8)->sum('grand_total')}}",
                        b: "{{$estimates_collection->get(8)->sum('grand_total')}}"
                    },
                    {
                        y: 10,
                        a: "{{$invoice_collection->get(9)->sum('grand_total')}}",
                        b: "{{$estimates_collection->get(9)->sum('grand_total')}}"
                    },
                    {
                        y: 11,
                        a: "{{$invoice_collection->get(10)->sum('grand_total')}}",
                        b: "{{$estimates_collection->get(10)->sum('grand_total')}}"
                    },
                    {
                        y: 12,
                        a: "{{$invoice_collection->get(11)->sum('grand_total')}}",
                        b: "{{$estimates_collection->get(11)->sum('grand_total')}}"
                    },
                ],
                xkey: 'y',
                ykeys: ['a', 'b'],
            ...
            Morris.Bar({
                ...
                data: [
                    ...
                    $m = $key;
                    @endphp {
                        y: "{{ \Carbon\Carbon::create(0,$m,1)->format('M') }}",
                        a: "{{ !empty($expense->get($key)) ? $expense->get($key)->sum('amount'): 0}}",
                        b: "{{ !empty($expense->get($key)) ? $expense->get($key)->count() : 0}}"
                    },
                    @endforeach
                    @endif
                ],
